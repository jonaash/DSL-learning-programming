...
public class ViewPlugin_ProjectPlugin extends BaseProjectPlugin {
  public ViewPlugin_ProjectPlugin() {
  }
  public List<BaseGeneratedTool> initAllTools(Project project) {
    ...
    ListSequence.fromList(tools).addElement(new KarelView_Tool(project));
    return tools;
  }
}
